...
export default class ScenePark extends Scene {
    ...
    render(canvas, translator) {
        ...
        const objectiveBorderR = CanvasUtil.loadNewImage('./assets/objectiveBorderR.png');
        ...
        const objectiveBorderL = CanvasUtil.loadNewImage('./assets/objectiveBorderL.png');
...
//# sourceMappingURL=ScenePark.js.map